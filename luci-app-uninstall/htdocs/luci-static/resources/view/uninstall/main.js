	...
	render: function() {
		...
		function renderSection(title, items){
			...
			var header = E('div', { 'style': 'display:flex; align-items:center; justify-content:space-between;' }, [
				E('h3', { 'style': 'margin:12px 0 0 0; font-size:18px; color:#111827; font-weight:700; display:inline-block; padding:6px 10px; border-radius:10px; background: linear-gradient(90deg, #fce7f3 0%, #e0f2fe 100%);' }, title)
			]);
